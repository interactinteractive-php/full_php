...
//        }
    ...
    public function getIndicatorDtlInfo($srcStrId, $data) {
        ...
        if ($getIndicatorDtl) {
            foreach ($getIndicatorDtl as $row) {
                if ($row['SEMANTIC_TYPE_ID'] == 10000002 && empty($row['TABLE_NAME'])) {
    ...
    public function checklistExportJson($structureIndicatorId = '', $recordId = '') {
        /**
         * dummy data
         */
        $selectedRowPost['id'] = 1714209995456770;
                ...
                foreach ($components as $comRow) {
                    if (isset($savedComponentRows[$comRow['MAP_ID']])) {
                        ...
                        foreach ($childRows as $savedComRow) {
                            $getParams = self::getMetaVerseBindParamRelation($structureIndicatorId, $comRow['ID'], $savedComRow['PF_MAP_RECORD_ID']);
                            $component[] = self::getIndicatorExportInfo($comRow['ID'], $structureIndicatorId, $getParams['param'], $getParams['idValue']);
                        }
                    }
                }
            }       
    ...
    public function checklistImportJson()
    {
        $importJson = '{
  "general": {
    "structureIndicatorId": "169987129260032",
    "clear": {
      "tableName": "VT_DATA.V_16716769902139",
      "column": "ID",
      "dtl": [
        {
          "tableName": "VT_DATA.V_17044272702389",
          "column": "SRC_RECORD_ID"
        }
      ]
    },
    "recordId": "1714209995456770",
    "data": {
      "ID": "1714209995456770",
      "C260": "Веритех ХХК",
      "C6": {
        "C573": "роөаимриө",
        "C572": "12",
        "C571": "1679393387012482",
        "C571_DESC": "Тийм",
        "C570": "36",
        "C569": "20",
        "C575": "800000000",
        "C568": "1671705084553205",
        "C568_DESC": "Ажлын байр дэмжих зээл"
      },
      "FIN_DATA_DATE": "2024-06-30 00:00:00",
      "C263": "finance@interactive.mn",
      "C262": "123456789",
      "C261": "5392489",
      "C17": [
        {
          "ID": "1714208164251286",
          "INDICATOR_ID": "17044272702389",
          "SRC_RECORD_ID": "1714209995456770",
          "DATA": null,
          "NAME": null,
          "C2": "16778251902449",
          "C2_DESC": "Орон сууц_худалдан авах",
          "C3": "16776635016289",
          "C3_DESC": "Орон сууц худалдан авах",
          "WFM_STATUS_ID": null,
          "WFM_DESCRIPTION": null,
          "CREATED_DATE": "2024-04-27 16:56:04",
          "CREATED_USER_ID": "16515415476389",
          "CREATED_USER_NAME": "Б.Нарантуяа",
          "MODIFIED_DATE": "2024-07-30 18:19:03",
          "MODIFIED_USER_ID": "16322933128171",
          "MODIFIED_USER_NAME": "Б.Оч-Эрдэнэ",
          "DELETED_DATE": null,
        ...
        },
        {
          ...
          "NAME": null,
          "C2": "16757659526599",
          "C2_DESC": "Эргэлтийн Хөрөнгө Нэмэгдүүлэх",
          "C3": "16757659528509",
          "C3_DESC": "Үйл ажиллагааны зардал санхүүжүүлэх",
          "WFM_STATUS_ID": null,
          "WFM_DESCRIPTION": null,
          "CREATED_DATE": "2024-07-30 17:31:34",
          "CREATED_USER_ID": "16188268806991",
          "CREATED_USER_NAME": "Б.Өнөрцэцэг",
          "MODIFIED_DATE": "2024-07-30 18:19:03",
          "MODIFIED_USER_ID": "16322933128171",
          "MODIFIED_USER_NAME": "Б.Оч-Эрдэнэ",
          "DELETED_DATE": null,
  ...
  "relation": [
    {
      "structureIndicatorId": "16759182831289",
      "clear": {
        "tableName": "VT_DATA.V_16759182831289",
        "column": "ID",
        "dtl": [
          {
            "tableName": "VT_DATA.V_17107591682089",
            "column": "SRC_RECORD_ID"
          }
        ]
      },
      "recordId": "1716352659849656",
      "data": {
        "ID": "1716352659849656",
        "C20": "asd",
        "C21": "asd",
        "C19": "asd",
        "C2": "1676349796981835",
        "C2_DESC": "ТТ-өө шинэчлэх - хүчин чадал нэмэгдэнэ",
        "C18": "asd",
        "C8": "",
        "C7": "",
        "C6": "1671698114091294",
        ...
        "C4_DESC": "Үгүй",
        "C3": "1676351343448274",
        "C3_DESC": "Ашиглагдаж байгаа - шинэвтэр",
        "C22": [],
        "C9": [
          {
            "ID": "1716351670344202",
            ...
            "WFM_STATUS_ID": null,
            "WFM_DESCRIPTION": null,
            "CREATED_DATE": "2024-05-22 12:21:11",
            "CREATED_USER_ID": "16521440257079",
            "CREATED_USER_NAME": "Э.Золбоо",
            "MODIFIED_DATE": null,
    ...
    {
      "structureIndicatorId": "169987130345232",
      "clear": {
        "tableName": "VT_DATA.V_16716769902139",
        "column": "ID",
        "dtl": [
          {
            "tableName": "VT_DATA.V_16751562271189",
            "column": "SRC_RECORD_ID"
          }
        ]
      },
        ...
        "C7": [
          {
            ...
            "WFM_STATUS_ID": null,
            "WFM_DESCRIPTION": null,
            "CREATED_DATE": "2024-07-30 17:34:07",
            "CREATED_USER_ID": "16188268806991",
            "CREATED_USER_NAME": "Б.Өнөрцэцэг",
            "MODIFIED_DATE": null,
            "MODIFIED_USER_ID": null,
    ...
    {
      "structureIndicatorId": "169987134376632",
      "clear": {
        "tableName": "VT_DATA.V_16716769902139",
        "column": "ID",
        "dtl": [
          {
            "tableName": "VT_DATA.V_16750635404219",
            "column": "SRC_RECORD_ID"
          }
        ]
      },
        ...
        "C10": [
          {
            ...
            "WFM_STATUS_ID": null,
            "WFM_DESCRIPTION": null,
            "CREATED_DATE": "2024-07-30 17:33:38",
            "CREATED_USER_ID": "16188268806991",
            "CREATED_USER_NAME": "Б.Өнөрцэцэг",
            "MODIFIED_DATE": null,
            "MODIFIED_USER_ID": null,
          ...
          },
          {
            ...
            "WFM_STATUS_ID": null,
            "WFM_DESCRIPTION": null,
            "CREATED_DATE": "2024-07-30 17:33:39",
            "CREATED_USER_ID": "16188268806991",
            "CREATED_USER_NAME": "Б.Өнөрцэцэг",
            "MODIFIED_DATE": null,
            "MODIFIED_USER_ID": null,
    ...
    {
      "structureIndicatorId": "169987134575232",
      "clear": {
        "tableName": "VT_DATA.V_16716769902139",
        "column": "ID",
        "dtl": [
          {
            "tableName": "VT_DATA.V_16750635364529",
            "column": "SRC_RECORD_ID"
          }
        ]
      },
        ...
        "C12": [
          {
            ...
            "WFM_STATUS_ID": null,
            "WFM_DESCRIPTION": null,
            "CREATED_DATE": "2024-06-18 18:37:43",
            "CREATED_USER_ID": "16521440257079",
            "CREATED_USER_NAME": "Э.Золбоо",
            "MODIFIED_DATE": "2024-07-30 17:36:56",
            "MODIFIED_USER_ID": "16188268806991",
            "MODIFIED_USER_NAME": "Б.Өнөрцэцэг",
            "DELETED_DATE": null,
            "DELETED_USER_ID": null,
            "DELETED_USER_NAME": null,
            "COMPANY_DEPARTMENT_ID": null,
          ...
          },
          {
            ...
            "WFM_STATUS_ID": null,
            "WFM_DESCRIPTION": null,
            "CREATED_DATE": "2024-07-30 17:36:57",
            "CREATED_USER_ID": "16188268806991",
            "CREATED_USER_NAME": "Б.Өнөрцэцэг",
            "MODIFIED_DATE": null,
            "MODIFIED_USER_ID": null,
            ...
            "GENERATED_DATE": null,
            "C1_DESC": null,
            "C6_DESC": "Бизнесийн хэрэгцээнд ашигладаг",
            "C8": "1671698109283983",
            "C8_DESC": "Тийм",
            "C9": "ихахиатр",
            "C11": "Интерактив групп",
            "C12": "5000000",
            "C13": "1671698109283983",
            "C13_DESC": "Тийм",
            "C14": "иатртр",
            "C15": "ирөмор",
            "C18": "20000000000"
    ...
    },
    {
      ...
      "clear": {
        ...
        "dtl": [
          {
            "tableName": "VT_DATA.V_16750635363069",
            "column": "SRC_RECORD_ID"
          }
        ]
      },
        ...
        "C11": [
          {
            ...
            "WFM_STATUS_ID": null,
            "WFM_DESCRIPTION": null,
            "CREATED_DATE": "2024-07-30 17:37:40",
            "CREATED_USER_ID": "16188268806991",
            "CREATED_USER_NAME": "Б.Өнөрцэцэг",
            "MODIFIED_DATE": null,
            "MODIFIED_USER_ID": null,
            ...
            "C7_DESC": "Тийм",
            "C1_DESC": null,
            "C2_DESC": "Бизнесийн хэрэгцээнд ашигладаг",
            "C8": "асөамаө",
            "C10": "Интерактив групп",
            "C11": "500000000"
          }
        ]
      },
    ...
    {
      "structureIndicatorId": "169987134839032",
      "clear": {
        "tableName": "VT_DATA.V_16716769902139",
        "column": "ID",
        "dtl": [
          {
            "tableName": "VT_DATA.V_18967362",
            "column": "SRC_RECORD_ID"
          }
        ]
      },
        ...
        "C6": [
          {
            ...
            "WFM_STATUS_ID": null,
            "WFM_DESCRIPTION": null,
            "CREATED_DATE": "2024-07-30 17:37:49",
            "CREATED_USER_ID": "16188268806991",
            "CREATED_USER_NAME": "Б.Өнөрцэцэг",
            "MODIFIED_DATE": null,
            "MODIFIED_USER_ID": null,
    ...
    {
      "structureIndicatorId": "169987134870432",
      "clear": {
        "tableName": "VT_DATA.V_16716769902139",
        "column": "ID",
        "dtl": [
          {
            "tableName": "VT_DATA.V_16750635423569",
            "column": "SRC_RECORD_ID"
          }
        ]
      },
        ...
        "C2": [
          {
            ...
            "WFM_STATUS_ID": null,
            "WFM_DESCRIPTION": null,
            "CREATED_DATE": "2024-07-30 17:38:01",
            "CREATED_USER_ID": "16188268806991",
            "CREATED_USER_NAME": "Б.Өнөрцэцэг",
            "MODIFIED_DATE": null,
            "MODIFIED_USER_ID": null,
    ...
    {
      "structureIndicatorId": "169987134893732",
      "clear": {
        "tableName": "VT_DATA.V_16716769902139",
        "column": "ID",
        "dtl": [
          {
            "tableName": "VT_DATA.V_169987134987532",
            "column": "SRC_RECORD_ID"
          }
        ]
      },
        ...
        "C2": [
          {
            ...
            "WFM_STATUS_ID": null,
            "WFM_DESCRIPTION": null,
            "CREATED_DATE": "2024-07-30 17:38:07",
            "CREATED_USER_ID": "16188268806991",
            "CREATED_USER_NAME": "Б.Өнөрцэцэг",
            "MODIFIED_DATE": null,
            "MODIFIED_USER_ID": null,
          ...
          },
          {
            ...
            "NAME": null,
            "C2": "54321",
            "C3": "2023-12-27 00:00:00",
            "C4": "2024-01-05 00:00:00",
            "C5": "4321",
            "C6": "43",
            "C7": "1671705422982859",
            "C7_DESC": "Газар тариалан",
            "C8": null,
            "C9": null,
            "WFM_STATUS_ID": null,
            "WFM_DESCRIPTION": null,
    ...
    {
      "structureIndicatorId": "169987133915332",
      "clear": {
        "tableName": "VT_DATA.V_16716769902139",
        "column": "ID",
        "dtl": [
          {
            "tableName": "VT_DATA.V_16751562807969",
            "column": "SRC_RECORD_ID"
          }
        ]
      },
        ...
        "C8": [
          {
            ...
            "C1_DESC": "Гэрээт ажил",
            "C2": "1673516038671176",
            "C2_DESC": "Бусад_Гэрээт_ажил",
            "C352": null,
            "C352_DESC": null,
            "WFM_STATUS_ID": null,
            "WFM_DESCRIPTION": null,
            "CREATED_DATE": "2024-07-30 17:38:15",
            "CREATED_USER_ID": "16188268806991",
            "CREATED_USER_NAME": "Б.Өнөрцэцэг",
            "MODIFIED_DATE": null,
            "MODIFIED_USER_ID": null,
          ...
          },
          {
            ...
            "GENERATED_DATE": null,
            "C3": "1673880561178617",
            "C3_DESC": "Програм_хангамж",
            "C5": null,
            "C6": "Та борлуулалтаа нэмэгдүүлмээр байна уу, Танд санхүүжилт хэрэгтэй байна уу, танд чадварлаг хүний нөөц хэрэгтэй байна уу, та бизнестээ инноваци нэвтрүүлмээр байна уу, Та бизнесээ гар утаснаасаа удирдмаар байна уу, Энэ бүгдийг танд Veritech cloud платформ өгөх болно."
          }
        ]
      },
      "component": []
    ...
    {
      "structureIndicatorId": "169987135175732",
      "clear": {
        "tableName": "VT_DATA.V_16716769902139",
        "column": "ID",
        "dtl": [
          {
            "tableName": "VT_DATA.V_16750634409209",
            "column": "SRC_RECORD_ID"
          }
        ]
      },
        ...
        "C9": [
          {
            ...
            "WFM_STATUS_ID": null,
            "WFM_DESCRIPTION": null,
            "CREATED_DATE": "2024-07-30 17:38:22",
            "CREATED_USER_ID": "16188268806991",
            "CREATED_USER_NAME": "Б.Өнөрцэцэг",
            "MODIFIED_DATE": null,
            "MODIFIED_USER_ID": null,
          ...
          },
          {
            ...
            "WFM_STATUS_ID": null,
            "WFM_DESCRIPTION": null,
            "CREATED_DATE": "2024-07-30 17:38:23",
            "CREATED_USER_ID": "16188268806991",
            "CREATED_USER_NAME": "Б.Өнөрцэцэг",
            "MODIFIED_DATE": null,
            "MODIFIED_USER_ID": null,
          ...
          },
          {
            ...
            "C5": null,
            "C1": "Түвшин",
            "C4": "маркетингийн хэлтсийн захирал",
            "WFM_STATUS_ID": null,
            "WFM_DESCRIPTION": null,
            "CREATED_DATE": "2024-07-30 17:38:23",
            "CREATED_USER_ID": "16188268806991",
    ...
    {
      "structureIndicatorId": "169987135236832",
      "clear": {
        "tableName": "VT_DATA.V_16716769902139",
        "column": "ID",
        "dtl": [
          {
            "tableName": "VT_DATA.V_16750634409989",
            "column": "SRC_RECORD_ID"
          }
        ]
      },
        ...
        "C13": [
          {
            ...
            "WFM_STATUS_ID": null,
            "WFM_DESCRIPTION": null,
            "CREATED_DATE": "2024-07-30 17:38:29",
            "CREATED_USER_ID": "16188268806991",
            "CREATED_USER_NAME": "Б.Өнөрцэцэг",
            "MODIFIED_DATE": null,
            "MODIFIED_USER_ID": null,
          ...
          },
          {
            ...
            "WFM_STATUS_ID": null,
            "WFM_DESCRIPTION": null,
            "CREATED_DATE": "2024-07-30 17:38:30",
            "CREATED_USER_ID": "16188268806991",
            "CREATED_USER_NAME": "Б.Өнөрцэцэг",
            "MODIFIED_DATE": null,
            "MODIFIED_USER_ID": null,
    ...
    {
      "structureIndicatorId": "169987135343332",
      "clear": {
        "tableName": "VT_DATA.V_16716769902139",
        "column": "ID",
        "dtl": [
          {
            "tableName": "VT_DATA.V_16750634410749",
            "column": "SRC_RECORD_ID"
          }
        ]
      },
        ...
        "C8": [
          {
            ...
            "WFM_STATUS_ID": null,
            "WFM_DESCRIPTION": null,
            "CREATED_DATE": "2024-07-30 17:38:37",
            "CREATED_USER_ID": "16188268806991",
            "CREATED_USER_NAME": "Б.Өнөрцэцэг",
            "MODIFIED_DATE": null,
            "MODIFIED_USER_ID": null,
    ...
    {
      "structureIndicatorId": "169987133948032",
      "clear": {
        "tableName": "VT_DATA.V_16716769902139",
        "column": "ID",
        "dtl": [
          {
            "tableName": "VT_DATA.V_197566113",
            "column": "SRC_RECORD_ID"
          }
        ]
      },
        ...
        "C7": [
          {
            ...
            "WFM_STATUS_ID": null,
            "WFM_DESCRIPTION": null,
            "CREATED_DATE": "2024-07-30 17:38:40",
            "CREATED_USER_ID": "16188268806991",
            "CREATED_USER_NAME": "Б.Өнөрцэцэг",
            "MODIFIED_DATE": null,
            "MODIFIED_USER_ID": null,
          ...
          },
          {
            ...
            "EMPLOYEE_ID": null,
            "C4": "Алтансувд",
            "C2": "анагаах ухааны доктор, клиникийн профессор, ахлах зэргийн эмч",
            "C3": null,
            "C1": null,
            "WFM_STATUS_ID": null,
            "WFM_DESCRIPTION": null,
    ...
    {
      "structureIndicatorId": "169987134093932",
      "clear": {
        "tableName": "VT_DATA.V_16716769902139",
        "column": "ID",
        "dtl": [
          {
            "tableName": "VT_DATA.V_16757416621929",
            "column": "SRC_RECORD_ID"
          }
        ]
      },
        ...
        "C12": [
          {
            ...
            "WFM_STATUS_ID": null,
            "WFM_DESCRIPTION": null,
            "CREATED_DATE": "2024-07-30 17:38:44",
            "CREATED_USER_ID": "16188268806991",
            "CREATED_USER_NAME": "Б.Өнөрцэцэг",
            "MODIFIED_DATE": null,
            "MODIFIED_USER_ID": null,
    ...
    {
      "structureIndicatorId": "169987142031832",
      "clear": {
        "tableName": "VT_DATA.V_16716769902139",
        "column": "ID",
        "dtl": [
          {
            "tableName": "VT_DATA.V_16753277828169",
            "column": "SRC_RECORD_ID"
          }
        ]
      },
    ...
    {
      "structureIndicatorId": "169987142114932",
      "clear": {
        "tableName": "VT_DATA.V_16716769902139",
        "column": "ID",
        "dtl": [
          {
            "tableName": "VT_DATA.V_16753278036689",
            "column": "SRC_RECORD_ID"
          }
        ]
      },
    ...
    {
      "structureIndicatorId": "169987135452332",
      "clear": {
        "tableName": "VT_DATA.V_16716769902139",
        "column": "ID",
        "dtl": [
          {
            "tableName": "VT_DATA.V_16757417139429",
            "column": "SRC_RECORD_ID"
          }
        ]
      },
        ...
        "C2": [
          {
            ...
            "WFM_STATUS_ID": null,
            "WFM_DESCRIPTION": null,
            "CREATED_DATE": "2024-07-30 17:38:49",
            "CREATED_USER_ID": "16188268806991",
            "CREATED_USER_NAME": "Б.Өнөрцэцэг",
            "MODIFIED_DATE": null,
            "MODIFIED_USER_ID": null,
    ...
    {
      "structureIndicatorId": "169987142506132",
      "clear": {
        "tableName": "VT_DATA.V_16716769902139",
        "column": "ID",
        "dtl": [
          {
            "tableName": "VT_DATA.V_169987142548332",
            "column": "SRC_RECORD_ID"
          }
        ]
      },
        ...
        "C2": [
          {
            ...
            "WFM_STATUS_ID": null,
            "WFM_DESCRIPTION": null,
            "CREATED_DATE": "2024-07-30 17:39:14",
            "CREATED_USER_ID": "16188268806991",
            "CREATED_USER_NAME": "Б.Өнөрцэцэг",
            "MODIFIED_DATE": null,
            "MODIFIED_USER_ID": null,
    ...
    {
      "structureIndicatorId": "17029609496459",
      "clear": {
        "tableName": "VT_DATA.V_16716769902139",
        "column": "ID",
        "dtl": []
    ...
    {
      "structureIndicatorId": "169987134254932",
      "clear": {
        "tableName": "VT_DATA.V_16716769902139",
        "column": "ID",
        "dtl": [
          {
            "tableName": "VT_DATA.V_16753277795879",
            "column": "SRC_RECORD_ID"
          }
        ]
      },
    ...
    {
      "structureIndicatorId": "169987134317832",
      "clear": {
        "tableName": "VT_DATA.V_16716769902139",
        "column": "ID",
        "dtl": [
          {
            "tableName": "VT_DATA.V_16757416645809",
            "column": "SRC_RECORD_ID"
          }
        ]
      },
      ...
      "data": {
        ...
        "C2": [
          {
            "ID": "1722332524748693",
            "INDICATOR_ID": "16757416645809",
            "SRC_RECORD_ID": "1714209995456770",
            "DATA": null,
            "NAME": null,
            "WFM_STATUS_ID": null,
            "WFM_DESCRIPTION": null,
            "CREATED_DATE": "2024-07-30 17:42:04",
            "CREATED_USER_ID": "16188268806991",
            "CREATED_USER_NAME": "Б.Өнөрцэцэг",
            "MODIFIED_DATE": null,
            "MODIFIED_USER_ID": null,
            ...
            "C17": null,
            "C17_DESC": null,
            "C1": "Бизнесийн ашгаас хувийн хэрэглээнд зарцуулсан эсэх",
            "C1_DESC": null,
            "C2": "2022",
            "C2_DESC": null,
            "C3": null,
          ...
          },
          {
            ...
            "C17": null,
            "C17_DESC": null,
            "C1": "Бизнест бусад эх үүсвэрээс хөрөнгө оруулсан уу",
            "C1_DESC": null,
            "C2": "2022",
            "C2_DESC": null,
            "C3": null,
          ...
          },
          {
            ...
            "C17": null,
            "C17_DESC": null,
            "C1": "Борлуулсан хөрөнгө байгаа бол",
            "C1_DESC": null,
            "C2": "2022",
            "C2_DESC": null,
            "C3": null,
    ...
    {
      "structureIndicatorId": "169987135517032",
      "clear": {
        "tableName": "VT_DATA.V_16716769902139",
        "column": "ID",
        "dtl": [
          {
            "tableName": "VT_DATA.V_16751561373899",
            "column": "SRC_RECORD_ID"
          }
        ]
      },
    ...
    {
      "structureIndicatorId": "169987141991032",
      "clear": {
        "tableName": "VT_DATA.V_16716769902139",
        "column": "ID",
        "dtl": [
          {
            "tableName": "VT_DATA.V_16751562765329",
            "column": "SRC_RECORD_ID"
          }
        ]
      },
    ...
    {
      "structureIndicatorId": "169987139691232",
      "clear": {
        "tableName": "VT_DATA.V_16716769902139",
        "column": "ID",
        "dtl": [
          {
            "tableName": "VT_DATA.V_16751561376899",
            "column": "SRC_RECORD_ID"
          }
        ]
      },
    ...
    {
      "structureIndicatorId": "169987141966432",
      "clear": {
        "tableName": "VT_DATA.V_16716769902139",
        "column": "ID",
        "dtl": [
          {
            "tableName": "VT_DATA.V_16751562662379",
            "column": "SRC_RECORD_ID"
          }
        ]
      },
    ...
    {
      "structureIndicatorId": "169987141156832",
      "clear": {
        "tableName": "VT_DATA.V_16716769902139",
        "column": "ID",
        "dtl": [
    ...
    {
      "structureIndicatorId": "169987141925032",
      "clear": {
        "tableName": "VT_DATA.V_16716769902139",
        "column": "ID",
        "dtl": [
          {
            "tableName": "VT_DATA.V_16751561378329",
            "column": "SRC_RECORD_ID"
          }
        ]
      },
      ...
      "data": {
        "ID": "1714209995456770",
        "C212": "a",
        "C633": "1671698109283983",
        "C633_DESC": "Тийм",
        "C561": "1671698109283983",
        "C561_DESC": "Тийм",
        "C215": "өиахиахи",
        "C214": "d",
        "C213": "s",
        "C2": [
          {
            ...
            "WFM_STATUS_ID": null,
            "WFM_DESCRIPTION": null,
            "CREATED_DATE": "2024-07-30 17:42:51",
            "CREATED_USER_ID": "16188268806991",
            "CREATED_USER_NAME": "Б.Өнөрцэцэг",
            "MODIFIED_DATE": null,
            "MODIFIED_USER_ID": null,
          ...
          },
          {
            ...
            "WFM_STATUS_ID": null,
            "WFM_DESCRIPTION": null,
            "CREATED_DATE": "2024-07-30 17:42:52",
            "CREATED_USER_ID": "16188268806991",
            "CREATED_USER_NAME": "Б.Өнөрцэцэг",
            "MODIFIED_DATE": null,
            "MODIFIED_USER_ID": null,
    ...
    {
      "structureIndicatorId": "169987141899032",
      "clear": {
        "tableName": "VT_DATA.V_16716769902139",
        "column": "ID",
        "dtl": [
          {
            "tableName": "VT_DATA.V_16750634671109",
            "column": "SRC_RECORD_ID"
          }
        ]
      },
      ...
      "data": {
        ...
        "C2": [
          {
            "ID": "1722332582421496",
            "INDICATOR_ID": "16750634671109",
            "SRC_RECORD_ID": "1714209995456770",
            "DATA": null,
            "NAME": null,
            "ROW_INDEX": null,
            "PARENT_ID": null,
            "C1": "Ажиллагсдын цалингийн зардал",
            "C1_DESC": null,
            "ROW_STYLE": null,
            "ROW_STYLE_DESC": null,
            "ROW_ID": null,
            ...
            "WFM_STATUS_ID": null,
            "WFM_DESCRIPTION": null,
            "CREATED_DATE": "2024-07-30 17:43:02",
            "CREATED_USER_ID": "16188268806991",
            "CREATED_USER_NAME": "Б.Өнөрцэцэг",
            "MODIFIED_DATE": null,
            "MODIFIED_USER_ID": null,
    ...
    {
      "structureIndicatorId": "17034808126809",
      "clear": {
        "tableName": "VT_DATA.V_16716769902139",
        "column": "ID",
        "dtl": []
    ...
    {
      "structureIndicatorId": "169987135090632",
      "clear": {
        "tableName": "VT_DATA.V_16716769902139",
        "column": "ID",
        "dtl": [
          {
            "tableName": "VT_DATA.V_167458278",
            "column": "SRC_RECORD_ID"
          }
        ]
      },
        ...
        "C2": [
          {
            ...
            "WFM_STATUS_ID": null,
            "WFM_DESCRIPTION": null,
            "CREATED_DATE": "2024-07-30 17:40:34",
            "CREATED_USER_ID": "16188268806991",
            "CREATED_USER_NAME": "Б.Өнөрцэцэг",
            "MODIFIED_DATE": null,
            "MODIFIED_USER_ID": null,
          ...
          },
          {
            ...
            "C162_DESC": "Түрээсийн",
            "C163": "10000",
            "C164": "2020-10-10 00:00:00",
            "C165": "500000000",
            "C166": null,
            "C166_DESC": null,
            "WFM_STATUS_ID": null,
            "WFM_DESCRIPTION": null,
            "CREATED_DATE": "2024-07-30 17:40:35",
            "CREATED_USER_ID": "16188268806991",
            "CREATED_USER_NAME": "Б.Өнөрцэцэг",
            "MODIFIED_DATE": null,
            "MODIFIED_USER_ID": null,
    ...
    {
      "structureIndicatorId": "169987135131232",
      "clear": {
        "tableName": "VT_DATA.V_16716769902139",
        "column": "ID",
        "dtl": [
          {
            "tableName": "VT_DATA.V_167458274",
            "column": "SRC_RECORD_ID"
          }
        ]
      },
        ...
        "C2": [
          {
            ...
            "C174": null,
            "C174_DESC": null,
            "C175": "1681378082243861",
            "WFM_STATUS_ID": null,
            "WFM_DESCRIPTION": null,
            "CREATED_DATE": "2024-07-30 17:41:20",
            "CREATED_USER_ID": "16188268806991",
            "CREATED_USER_NAME": "Б.Өнөрцэцэг",
            "MODIFIED_DATE": null,
            "MODIFIED_USER_ID": null,
          ...
          },
          {
            ...
            "C168": "2",
            "C169": null,
            "C170": "1673510442769029",
            "C170_DESC": "Түрээсийн",
            "C171": "5555",
            "C172": "2024-12-31 00:00:00",
            "C173": "5000000",
            "C174": null,
            "C174_DESC": null,
            "C175": null,
            "WFM_STATUS_ID": null,
            "WFM_DESCRIPTION": null,
            "CREATED_DATE": "2024-07-30 17:41:21",
            "CREATED_USER_ID": "16188268806991",
            "CREATED_USER_NAME": "Б.Өнөрцэцэг",
            "MODIFIED_DATE": null,
            "MODIFIED_USER_ID": null,
    ...
    {
      "structureIndicatorId": "169987141826532",
      "clear": {
        "tableName": "VT_DATA.V_16716769902139",
        "column": "ID",
        "dtl": [
          {
            "tableName": "VT_DATA.V_169984991354832",
            "column": "SRC_RECORD_ID"
          }
        ]
      },
        ...
        "C2": [
          {
            ...
            "NAME": null,
            "C2": "1",
            "C3": "2020-01-01 00:00:00",
            "C4": "10000",
            "C5": "атрихр",
            "C6": "1671698109283983",
            "C6_DESC": "Тийм",
            "C7": "2021-01-01 00:00:00",
            "C8": "5000",
            "C9": "хиөтхт",
            "C10": "1671698114091294",
            "C10_DESC": "Үгүй",
            "C12": "2020",
            "C11": "1671698109283983",
            "C11_DESC": "Тийм",
            "WFM_STATUS_ID": null,
            "WFM_DESCRIPTION": null,
            "CREATED_DATE": "2024-07-30 17:43:54",
            "CREATED_USER_ID": "16188268806991",
            "CREATED_USER_NAME": "Б.Өнөрцэцэг",
            "MODIFIED_DATE": null,
            "MODIFIED_USER_ID": null,
    ...
    {
      "structureIndicatorId": "169988165883632",
      "clear": {
        "tableName": "VT_DATA.V_16716769902139",
        "column": "ID",
        "dtl": []
      ...
      "component": [
        {
          "structureIndicatorId": "198145698",
          "clear": {
            "tableName": "DM_BALANCE_SHEET_MART_BOOK",
            "column": "ID",
            "dtl": [
              {
                "tableName": "DM_BALANCE_SHEET_MART",
                "column": "BOOK_ID",
                "id": "1722424368973911"
              }
            ]
          },
          "recordId": "1722424368973911",
          "data": {
            "DEPARTMENT_ID": "1",
            "IS_IMPORT": "1",
            "ID": "1722424368973911",
            "FISCAL_PERIOD_ID": "16412918953591",
            "C5": [
              {
                "ID": "1722422592727894",
                "BOOK_ID": "1722424368973911",
                "TEMPLATE_ID": "1686820327601422",
                "DEPARTMENT_ID": "1",
                "FISCAL_PERIOD_ID": "16412918953591",
                "ORDER_NUM": "1",
                "CODE": "1",
                "NAME": "ХӨРӨНГӨ",
                "BEGIN_AMOUNT": "50000000",
                "END_AMOUNT": "7138800"
              },
              {
                "ID": "1722423298675552",
                "BOOK_ID": "1722424368973911",
                "TEMPLATE_ID": "1686819464330158",
                "DEPARTMENT_ID": "1",
                "FISCAL_PERIOD_ID": "16412918953591",
                "ORDER_NUM": "2",
                "CODE": "1.1",
              ...
              },
              {
                "ID": "1722425693941659",
                "BOOK_ID": "1722424368973911",
                "TEMPLATE_ID": "1686821317297592",
                "DEPARTMENT_ID": "1",
                "FISCAL_PERIOD_ID": "16412918953591",
                "ORDER_NUM": "3",
                "CODE": "1.1.1",
                "NAME": "Мөнгө,түүнтэй адилтгах хөрөнгө",
                "BEGIN_AMOUNT": "4881233",
                "END_AMOUNT": "120000"
              },
              {
                "ID": "1722424883903723",
                "BOOK_ID": "1722424368973911",
                "TEMPLATE_ID": "1686817123114108",
                "DEPARTMENT_ID": "1",
                "FISCAL_PERIOD_ID": "16412918953591",
                "ORDER_NUM": "4",
                "CODE": "1.1.2",
              ...
              },
              {
                "ID": "1722427732492589",
                "BOOK_ID": "1722424368973911",
                "TEMPLATE_ID": "1686826513642679",
                "DEPARTMENT_ID": "1",
                "FISCAL_PERIOD_ID": "16412918953591",
                "ORDER_NUM": "5",
                "CODE": "1.1.3",
                "NAME": "Үнэлгээний хасагдуулга",
                "BEGIN_AMOUNT": "12480000",
                "END_AMOUNT": "500000"
              },
              {
                "ID": "1722423446517059",
                "BOOK_ID": "1722424368973911",
                "TEMPLATE_ID": "1686823950215671",
                "DEPARTMENT_ID": "1",
                "FISCAL_PERIOD_ID": "16412918953591",
                "ORDER_NUM": "6",
                "CODE": "1.1.4",
              ...
              },
              {
                "ID": "1722426290653573",
                "BOOK_ID": "1722424368973911",
                "TEMPLATE_ID": "1686818156267167",
                "DEPARTMENT_ID": "1",
                "FISCAL_PERIOD_ID": "16412918953591",
                "ORDER_NUM": "7",
                "CODE": "1.1.5",
                "NAME": "Найдваргүй авлагын хасагдуулга",
                "BEGIN_AMOUNT": "25484",
                "END_AMOUNT": "8250000"
              },
              {
              ...
              },
              {
                "ID": "1722439348269455",
                "BOOK_ID": "1722424368973911",
                "TEMPLATE_ID": "1686824020561859",
                "DEPARTMENT_ID": "1",
                "FISCAL_PERIOD_ID": "16412918953591",
                "ORDER_NUM": "9",
                "CODE": "1.1.7",
                "NAME": "Урьдчилж төлсөн зардал/тооцоо",
                "BEGIN_AMOUNT": "4800000",
                "END_AMOUNT": "15448"
              },
              {
                "ID": "1722432926908294",
                "BOOK_ID": "1722424368973911",
                "TEMPLATE_ID": "1686841026408420",
                "DEPARTMENT_ID": "1",
                "FISCAL_PERIOD_ID": "16412918953591",
                "ORDER_NUM": "10",
                "CODE": "1.1.8",
                "NAME": "Бусад эргэлтийн хөрөнгө",
                "BEGIN_AMOUNT": "4810000",
                "END_AMOUNT": "4800000"
              },
              {
                "ID": "1722423173055676",
                "BOOK_ID": "1722424368973911",
                "TEMPLATE_ID": "1686843426416196",
                "DEPARTMENT_ID": "1",
                "FISCAL_PERIOD_ID": "16412918953591",
                "ORDER_NUM": "11",
                "CODE": "1.1.9",
                "NAME": "Борлуулах зорилгоор эзэмшиж буй эргэлтийн бус хөрөнгө (борлуулах бүлэг хөрөнгө)",
                "BEGIN_AMOUNT": "4581",
                "END_AMOUNT": "4810000"
              },
              {
              ...
              },
              {
                "ID": "1722430597172276",
                "BOOK_ID": "1722424368973911",
                "TEMPLATE_ID": "1686834558326506",
                "DEPARTMENT_ID": "1",
                "FISCAL_PERIOD_ID": "16412918953591",
                "ORDER_NUM": "13",
                "CODE": "1.1.11",
                "NAME": "Эргэлтийн хөрөнгийн дүн",
                "BEGIN_AMOUNT": "672",
                "END_AMOUNT": "0"
              },
              {
                "ID": "1722450217664350",
                "BOOK_ID": "1722424368973911",
                "TEMPLATE_ID": "1686846141591504",
                "DEPARTMENT_ID": "1",
                "FISCAL_PERIOD_ID": "16412918953591",
                "ORDER_NUM": "14",
                "CODE": "1.2",
                "NAME": "Эргэлтийн бус хөрөнгө",
                "BEGIN_AMOUNT": "6991000",
                "END_AMOUNT": "451222"
              },
              {
                "ID": "1722438810615000",
                "BOOK_ID": "1722424368973911",
                "TEMPLATE_ID": "1686848022557796",
                "DEPARTMENT_ID": "1",
                "FISCAL_PERIOD_ID": "16412918953591",
                "ORDER_NUM": "15",
                "CODE": "1.2.1",
                "NAME": "Үндсэн хөрөнгө",
                "BEGIN_AMOUNT": "7138800",
                "END_AMOUNT": "4881233"
              },
              {
                "ID": "1722451499812325",
                "BOOK_ID": "1722424368973911",
                "TEMPLATE_ID": "1686846200755091",
                "DEPARTMENT_ID": "1",
                "FISCAL_PERIOD_ID": "16412918953591",
                "ORDER_NUM": "16",
                "CODE": "1.2.2",
              ...
              },
              {
                "ID": "1722455067611885",
                "BOOK_ID": "1722424368973911",
                "TEMPLATE_ID": "1686816860913345",
                "DEPARTMENT_ID": "1",
                "FISCAL_PERIOD_ID": "16412918953591",
                "ORDER_NUM": "17",
                "CODE": "1.2.3",
                "NAME": "Биологийн хөрөнгө",
                "BEGIN_AMOUNT": "120000",
                "END_AMOUNT": "12480000"
              },
              {
                "ID": "1722424071153763",
                "BOOK_ID": "1722424368973911",
                "TEMPLATE_ID": "1686836294411903",
                "DEPARTMENT_ID": "1",
                "FISCAL_PERIOD_ID": "16412918953591",
                "ORDER_NUM": "18",
                "CODE": "1.2.4",
                "NAME": "Урт хугацаат хөрөнгө оруулалт",
                "BEGIN_AMOUNT": "100000",
                "END_AMOUNT": "844812"
              },
              {
                "ID": "1722442507924805",
                "BOOK_ID": "1722424368973911",
                "TEMPLATE_ID": "1686845373150216",
                "DEPARTMENT_ID": "1",
                "FISCAL_PERIOD_ID": "16412918953591",
                "ORDER_NUM": "19",
                "CODE": "1.2.5",
                "NAME": "Хайгуул ба үнэлгээний хөрөнгө",
                "BEGIN_AMOUNT": "500000",
                "END_AMOUNT": "25484"
              },
              {
                "ID": "1722439486179505",
                "BOOK_ID": "1722424368973911",
                "TEMPLATE_ID": "1686829244623922",
                "DEPARTMENT_ID": "1",
                "FISCAL_PERIOD_ID": "16412918953591",
                "ORDER_NUM": "20",
                "CODE": "1.2.6",
                "NAME": "Хойшлогдсон татварын хөрөнгө",
                "BEGIN_AMOUNT": "60000",
                "END_AMOUNT": "15448"
              },
              {
                "ID": "1722433479146305",
                "BOOK_ID": "1722424368973911",
                "TEMPLATE_ID": "1686829738233610",
                "DEPARTMENT_ID": "1",
                "FISCAL_PERIOD_ID": "16412918953591",
                "ORDER_NUM": "21",
                "CODE": "1.2.7",
                "NAME": "Хөрөнгө оруулалтын зориулалттай үл хөдлөх хөрөнгө",
                "BEGIN_AMOUNT": "8250000",
                "END_AMOUNT": "4800000"
              },
              {
                "ID": "1722438459414502",
                "BOOK_ID": "1722424368973911",
                "TEMPLATE_ID": "1686839910859400",
                "DEPARTMENT_ID": "1",
                "FISCAL_PERIOD_ID": "16412918953591",
                "ORDER_NUM": "22",
                "CODE": "1.2.8",
                "NAME": "Бусад эргэлтийн бус хөрөнгө",
                "BEGIN_AMOUNT": "0",
                "END_AMOUNT": "4810000"
              },
              {
              ...
              },
              {
                "ID": "1722469387839112",
                "BOOK_ID": "1722424368973911",
                "TEMPLATE_ID": "1686826531628107",
                "DEPARTMENT_ID": "1",
                "FISCAL_PERIOD_ID": "16412918953591",
                "ORDER_NUM": "24",
                "CODE": "1.2.20",
                "NAME": "Эргэлтийн бус хөрөнгийн дүн",
                "BEGIN_AMOUNT": "0",
                "END_AMOUNT": "0"
              },
              {
                "ID": "1722454467230843",
                "BOOK_ID": "1722424368973911",
                "TEMPLATE_ID": "1686863178254354",
                "DEPARTMENT_ID": "1",
                "FISCAL_PERIOD_ID": "16412918953591",
                "ORDER_NUM": "25",
                "CODE": "1.3",
                "NAME": "НИЙТ ХӨРӨНГИЙН ДҮН",
                "BEGIN_AMOUNT": "0",
                "END_AMOUNT": "0"
              },
              {
                "ID": "1722469480146802",
                "BOOK_ID": "1722424368973911",
                "TEMPLATE_ID": "1686858662815787",
                "DEPARTMENT_ID": "1",
                "FISCAL_PERIOD_ID": "16412918953591",
                "ORDER_NUM": "26",
                "CODE": "2",
                "NAME": "ӨР ТӨЛБӨР БА ЭЗЭМШИГЧДИЙН ӨМЧ",
                "BEGIN_AMOUNT": "0",
                "END_AMOUNT": "0"
              },
              {
              ...
              },
              {
                "ID": "1722444720324051",
                "BOOK_ID": "1722424368973911",
                "TEMPLATE_ID": "1686873882461836",
                "DEPARTMENT_ID": "1",
                "FISCAL_PERIOD_ID": "16412918953591",
                "ORDER_NUM": "28",
                "CODE": "2.1.1",
                "NAME": "Богино хугацаат өр төлбөр",
                "BEGIN_AMOUNT": "0",
                "END_AMOUNT": "0"
              },
              {
              ...
              },
              {
                "ID": "1722450215818309",
                "BOOK_ID": "1722424368973911",
                "TEMPLATE_ID": "1686890594377477",
                "DEPARTMENT_ID": "1",
                "FISCAL_PERIOD_ID": "16412918953591",
                "ORDER_NUM": "33",
                "CODE": "2.1.1.5",
                "NAME": "Богино хугацаат зээл",
                "BEGIN_AMOUNT": "0",
                "END_AMOUNT": "0"
              },
              {
              ...
              },
              {
                "ID": "1722465542350829",
                "BOOK_ID": "1722424368973911",
                "TEMPLATE_ID": "1686873379887768",
                "DEPARTMENT_ID": "1",
                "FISCAL_PERIOD_ID": "16412918953591",
                "ORDER_NUM": "35",
                "CODE": "2.1.1.7",
                "NAME": "Ногдол ашгийн өглөг",
                "BEGIN_AMOUNT": "0",
                "END_AMOUNT": "0"
              },
              {
                "ID": "1722484088606695",
                "BOOK_ID": "1722424368973911",
                "TEMPLATE_ID": "1686872044098825",
                "DEPARTMENT_ID": "1",
                "FISCAL_PERIOD_ID": "16412918953591",
                "ORDER_NUM": "36",
                "CODE": "2.1.1.8",
                "NAME": "Урьдчилж орсон орлого",
                "BEGIN_AMOUNT": "0",
                "END_AMOUNT": "0"
              },
              {
              ...
              },
              {
                "ID": "1722444304818486",
                "BOOK_ID": "1722424368973911",
                "TEMPLATE_ID": "1686855922293090",
                "DEPARTMENT_ID": "1",
                "FISCAL_PERIOD_ID": "16412918953591",
                "ORDER_NUM": "38",
                "CODE": "2.1.1.10",
                "NAME": "Бусад богино хугацаат өр төлбөр",
                "BEGIN_AMOUNT": "0",
                "END_AMOUNT": "0"
              },
              {
                "ID": "1722487531153420",
                "BOOK_ID": "1722424368973911",
                "TEMPLATE_ID": "1686874786409086",
                "DEPARTMENT_ID": "1",
                "FISCAL_PERIOD_ID": "16412918953591",
                "ORDER_NUM": "39",
                "CODE": "2.1.1.11",
                "NAME": "Борлуулах зорилгоор эзэмшиж буй эргэлтийн бус хөрөнгө (борлуулах бүлэг хөрөнгө) - нд хамаарах өр төлбөр",
                "BEGIN_AMOUNT": "0",
                "END_AMOUNT": "0"
              },
              {
              ...
              },
              {
                "ID": "1722468357368431",
                "BOOK_ID": "1722424368973911",
                "TEMPLATE_ID": "1686851323395128",
                "DEPARTMENT_ID": "1",
                "FISCAL_PERIOD_ID": "16412918953591",
                "ORDER_NUM": "41",
                "CODE": "2.1.1.13",
                "NAME": "Богино хугацаат өр төлбөрийн дүн",
                "BEGIN_AMOUNT": "0",
                "END_AMOUNT": "0"
              },
              {
                "ID": "1722501366661300",
                "BOOK_ID": "1722424368973911",
                "TEMPLATE_ID": "1686899462356832",
                "DEPARTMENT_ID": "1",
                "FISCAL_PERIOD_ID": "16412918953591",
                "ORDER_NUM": "42",
                "CODE": "2.1.2",
                "NAME": "Урт хугацаат өр төлбөр",
                "BEGIN_AMOUNT": "0",
                "END_AMOUNT": "0"
              },
              {
                "ID": "1722498498264573",
                "BOOK_ID": "1722424368973911",
                "TEMPLATE_ID": "1686899844040025",
                "DEPARTMENT_ID": "1",
                "FISCAL_PERIOD_ID": "16412918953591",
                "ORDER_NUM": "43",
                "CODE": "2.1.2.1",
                "NAME": "Урт хугацаат зээл",
                "BEGIN_AMOUNT": "0",
                "END_AMOUNT": "0"
              },
              {
              ...
              },
              {
                "ID": "1722475005252017",
                "BOOK_ID": "1722424368973911",
                "TEMPLATE_ID": "1686828546460246",
                "DEPARTMENT_ID": "1",
                "FISCAL_PERIOD_ID": "16412918953591",
                "ORDER_NUM": "45",
                "CODE": "2.1.2.3",
                "NAME": "Хойшлогдсон татварын өр",
                "BEGIN_AMOUNT": "0",
                "END_AMOUNT": "0"
              },
              {
                "ID": "1722515980753551",
                "BOOK_ID": "1722424368973911",
                "TEMPLATE_ID": "1686849842145616",
                "DEPARTMENT_ID": "1",
                "FISCAL_PERIOD_ID": "16412918953591",
                "ORDER_NUM": "46",
                "CODE": "2.1.2.4",
                "NAME": "Бусад урт хугацаат өглөг",
                "BEGIN_AMOUNT": "0",
                "END_AMOUNT": "0"
              },
              {
              ...
              },
              {
                "ID": "1722461211544306",
                "BOOK_ID": "1722424368973911",
                "TEMPLATE_ID": "1686835350598070",
                "DEPARTMENT_ID": "1",
                "FISCAL_PERIOD_ID": "16412918953591",
                "ORDER_NUM": "48",
                "CODE": "2.1.2.6",
                "NAME": "Урт хугацаат өр төлбөрийн дүн",
                "BEGIN_AMOUNT": "0",
                "END_AMOUNT": "0"
              },
              {
                "ID": "1722480763609290",
                "BOOK_ID": "1722424368973911",
                "TEMPLATE_ID": "1686890024948242",
                "DEPARTMENT_ID": "1",
                "FISCAL_PERIOD_ID": "16412918953591",
                "ORDER_NUM": "49",
                "CODE": "2.2",
                "NAME": "Өр төлбөрийн нийт дүн",
                "BEGIN_AMOUNT": "0",
                "END_AMOUNT": "0"
              },
              {
              ...
              },
              {
                "ID": "1722529196771531",
                "BOOK_ID": "1722424368973911",
                "TEMPLATE_ID": "1686858028867385",
                "DEPARTMENT_ID": "1",
                "FISCAL_PERIOD_ID": "16412918953591",
                "ORDER_NUM": "54",
                "CODE": "2.3.4",
                "NAME": "Халаасны хувьцаа",
                "BEGIN_AMOUNT": "0",
                "END_AMOUNT": "0"
              },
              {
                "ID": "1722458033682599",
                "BOOK_ID": "1722424368973911",
                "TEMPLATE_ID": "1686853778048701",
                "DEPARTMENT_ID": "1",
                "FISCAL_PERIOD_ID": "16412918953591",
                "ORDER_NUM": "55",
                "CODE": "2.3.5",
                "NAME": "Нэмж төлөгдсөн капитал",
                "BEGIN_AMOUNT": "0",
                "END_AMOUNT": "0"
              },
              {
                "ID": "1722439890048701",
                "BOOK_ID": "1722424368973911",
                "TEMPLATE_ID": "1686847183121182",
                "DEPARTMENT_ID": "1",
                "FISCAL_PERIOD_ID": "16412918953591",
                "ORDER_NUM": "56",
                "CODE": "2.3.6",
                "NAME": "Хөрөнгийн дахин үнэлгээний нэмэгдэл",
                "BEGIN_AMOUNT": "0",
                "END_AMOUNT": "0"
              },
              {
                "ID": "1722491031504918",
                "BOOK_ID": "1722424368973911",
                "TEMPLATE_ID": "1686834571774011",
                "DEPARTMENT_ID": "1",
                "FISCAL_PERIOD_ID": "16412918953591",
                "ORDER_NUM": "57",
                "CODE": "2.3.7",
                "NAME": "Гадаад валютын хөрвүүлгийн нөөц",
                "BEGIN_AMOUNT": "0",
                "END_AMOUNT": "0"
              },
              {
                "ID": "1722518287026827",
                "BOOK_ID": "1722424368973911",
                "TEMPLATE_ID": "1686877135239892",
                "DEPARTMENT_ID": "1",
                "FISCAL_PERIOD_ID": "16412918953591",
                "ORDER_NUM": "58",
                "CODE": "2.3.8",
                "NAME": "Эздийн өмчийн бусад хэсэг",
                "BEGIN_AMOUNT": "0",
                "END_AMOUNT": "0"
              },
              {
                "ID": "1722454662241328",
                "BOOK_ID": "1722424368973911",
                "TEMPLATE_ID": "1686888748310181",
                "DEPARTMENT_ID": "1",
                "FISCAL_PERIOD_ID": "16412918953591",
                "ORDER_NUM": "59",
                "CODE": "2.3.9",
                "NAME": "Хуримтлагдсан ашиг",
                "BEGIN_AMOUNT": "0",
                "END_AMOUNT": "0"
              },
              {
              ...
              },
              {
                "ID": "1722471941424737",
                "BOOK_ID": "1722424368973911",
                "TEMPLATE_ID": "1686916133385774",
                "DEPARTMENT_ID": "1",
                "FISCAL_PERIOD_ID": "16412918953591",
                "ORDER_NUM": "61",
                "CODE": "2.3.11",
                "NAME": "Эздийн өмчийн дүн",
                "BEGIN_AMOUNT": "0",
                "END_AMOUNT": "0"
              },
              {
                "ID": "1722432581536380",
                "BOOK_ID": "1722424368973911",
                "TEMPLATE_ID": "1686911896477358",
                "DEPARTMENT_ID": "1",
                "FISCAL_PERIOD_ID": "16412918953591",
                "ORDER_NUM": "62",
                "CODE": "2.4",
                "NAME": "ӨР ТӨЛБӨР БА ЭЗДИЙН ӨМЧИЙН ДҮН",
                "BEGIN_AMOUNT": "0",
                "END_AMOUNT": "0"
              }
            ]
    ...
    {
      "structureIndicatorId": "169988165931932",
      "clear": {
        "tableName": "VT_DATA.V_16716769902139",
        "column": "ID",
        "dtl": []
    ...
    {
      "structureIndicatorId": "169984283414232",
      "clear": {
        "tableName": "VT_DATA.V_169984283414232",
        "column": "ID",
        "dtl": []
      },
      "recordId": "1722336225431996",
      "data": {
        "C2": "",
        "C6": "",
        "ID": "1722336225431996",
    ...
    },
    {
      ...
      "recordId": "1722336523435680",
      "data": {
        "C2": "",
        "C6": "",
        "ID": "1722336523435680",
        "C9": "1700020585382724",
        "C9_DESC": "Төсөл /Төслийн зээлийн хувьд/",
        "C7": "Төслийг бүрэн байдлаар файлаар хавсаргана уу\r\n/Хэрэв төслийг файлаар хавсаргах боломжгүй тохиолдолд зээлийн ажилтанд цаасаар хүлээлгэн өгнө үү/",
        "C8": "",
        "C3": "1722335088909180",
        "C5": "ghmh,k,h,j"
      },
    ...
    {
      "structureIndicatorId": "169984283580232",
      "clear": {
        "tableName": "VT_DATA.V_169984283580232",
        "column": "ID",
        "dtl": []
      },
      "recordId": "1722575332061700",
      "data": {
        "C2": "",
        "C6": "",
        "ID": "1722575332061700",
        "C9": "1700020285140165",
        "C9_DESC": "Хувьцаа эзэмшигчдийн хурлын шийдвэр",
        "C7": "Жишээ файл татаж харна уу",
        "C8": "",
        "C3": "1722574190806121",
        "C5": "Test data"
      },
    ...
    },
    {
      ...
      "recordId": "1722574974998992",
      "data": {
        "C2": "",
        "C6": "",
        "ID": "1722574974998992",
        "C9": "1700020739905182",
        "C9_DESC": "Хуулийн этгээдийн дэлгэрэнгүй лавлагаа",
        "C7": "Жишээ файл харна уу",
        "C8": "",
        "C3": "1722574251892867",
        "C5": "Test data 222"
      },
    ...
    {
      "structureIndicatorId": "16759182805649",
      "clear": {
        "tableName": "",
        "column": "ID",
        "dtl": [
    ...
    {
      "structureIndicatorId": "16776635362799",
      "clear": {
        "tableName": "",
        "column": "ID",
        "dtl": []
    ...
    {
      "structureIndicatorId": "16778287939099",
      "clear": {
        "tableName": "",
        "column": "ID",
        "dtl": []
    ...
    {
      "structureIndicatorId": "16775779311999",
      "clear": {
        "tableName": "",
        "column": "ID",
        "dtl": [
          ...
          {
            "tableName": "VT_DATA.V_17107597980599",
            "column": "SRC_RECORD_ID"
          }
        ]
      },
    ...
    {
      "structureIndicatorId": "16778287927309",
      "clear": {
        "tableName": "",
        "column": "ID",
        "dtl": []
    ...
    {
      "structureIndicatorId": "16776634877399",
      "clear": {
        "tableName": "VT_DATA.V_16776634877399",
        "column": "ID",
        "dtl": []
      },
      "recordId": 1714209995456770,
    ...
    {
      "structureIndicatorId": "16776634889659",
      "clear": {
        "tableName": "VT_DATA.V_16776634889659",
        "column": "ID",
        "dtl": [
          {
            "tableName": "VT_DATA.V_17110768948749",
            "column": "SRC_RECORD_ID"
          }
        ]
      },
    ...
    {
      "structureIndicatorId": "16776634435649",
      "clear": {
        "tableName": "VT_DATA.V_16776634435649",
        "column": "ID",
        "dtl": [
          {
            "tableName": null,
    ...
    {
      "structureIndicatorId": "16778251938209",
      "clear": {
        "tableName": "VT_DATA.V_16778251938209",
        "column": "ID",
        "dtl": []
      },
      "recordId": 1714209995456770,
    ...
    {
      "structureIndicatorId": "16778310865819",
      "clear": {
        "tableName": "VT_DATA.V_16778310865819",
        "column": "ID",
        "dtl": []
      },
      "recordId": 1714209995456770,
    ...
    {
      "structureIndicatorId": "16778310863259",
      "clear": {
        "tableName": "",
        "column": "ID",
        "dtl": []
    ...
    {
      "structureIndicatorId": "16759182802179",
      "clear": {
        "tableName": "VT_DATA.V_16759182802179",
        "column": "ID",
        "dtl": [
          {
            "tableName": null,
    ...
    {
      "structureIndicatorId": "177214325",
      "clear": {
        "tableName": "VT_DATA.V_177214325",
        "column": "ID",
        "dtl": [
          {
            "tableName": null,
    ...
    {
      "structureIndicatorId": "16776635377929",
      "clear": {
        "tableName": "",
        "column": "ID",
        "dtl": []
    ...
    {
      "structureIndicatorId": "16776634993449",
      "clear": {
        "tableName": "",
        "column": "ID",
        "dtl": []
    ...
    {
      "structureIndicatorId": "16757659528509",
      "clear": {
        "tableName": "VT_DATA.V_16757659528509",
        "column": "ID",
        "dtl": []
      },
      "recordId": "1722332634272368",
      "data": {
        "ID": "1722332634272368",
        "C2": "1672718773261375",
        "C3": "1672719431262363",
        ...
        "C5": [
          {
            "C7": "түрээс json-с хадгалав",
            "C8": "500000000",
            "C9": "400000000",
            "C10": "100000000",
            "C11": "30000000",
            "C12": "70000000",
            "C13": "борлуулалтын орлогоос",
            "rowState": "add"
          }
        ]
      },
    ...
    {
      "structureIndicatorId": "177214566",
      "clear": {
        "tableName": "VT_DATA.V_177214566",
        "column": "ID",
        "dtl": [
          {
            "tableName": "VT_DATA.V_17110768112159",
            "column": "SRC_RECORD_ID"
          },
          {
            "tableName": "VT_DATA.V_17110768129449",
            "column": "SRC_RECORD_ID"
          },
          {
            "tableName": "VT_DATA.V_17110768133249",
            "column": "SRC_RECORD_ID"
          }
        ]
      },
      "recordId": "1716947167626200",
      "data": {
        "ID": "1716947167626200",
        "C39": "",
        "C40": "",
        ...
        "C2": [
          {
            "ID": "1716946979886656",
            "INDICATOR_ID": "17110768112159",
            "SRC_RECORD_ID": "1716947167626200",
            "DATA": null,
            "NAME": null,
            "C2": null,
            "C2_DESC": null,
            ...
            "WFM_STATUS_ID": null,
            "WFM_DESCRIPTION": null,
            "CREATED_DATE": "2024-05-29 09:42:59",
            "CREATED_USER_ID": "16521440257079",
            "CREATED_USER_NAME": "Э.Золбоо",
            "MODIFIED_DATE": null,
            "MODIFIED_USER_ID": null,
    ...
    {
      "structureIndicatorId": "177215122",
      "clear": {
        "tableName": "",
        "column": "ID",
        "dtl": []
    ...
    {
      "structureIndicatorId": "177097870",
      "clear": {
        "tableName": "VT_DATA.V_177097870",
        "column": "ID",
        "dtl": [
          {
            "tableName": "VT_DATA.V_17107584280509",
            "column": "SRC_RECORD_ID"
          }
        ]
      },
      "recordId": "1718707078362721",
      "data": {
        "ID": "1718707078362721",
        "C3": "1676364132177300",
        "C17": "1677811335015624",
        "C16": "",
        "C6": "",
        "C4": "",
        "C18": [],
        "C2": [
          {
            "ID": "1718704938401563",
            "INDICATOR_ID": "17107584280509",
            "SRC_RECORD_ID": "1718707078362721",
            "DATA": null,
            "NAME": null,
            "C2": null,
            "C3": null,
            ...
            "WFM_STATUS_ID": null,
            "WFM_DESCRIPTION": null,
            "CREATED_DATE": "2024-06-18 18:02:18",
            "CREATED_USER_ID": "16521440257079",
            "CREATED_USER_NAME": "Э.Золбоо",
            "MODIFIED_DATE": "2024-06-18 18:06:54",
            "MODIFIED_USER_ID": "16521440257079",
            "MODIFIED_USER_NAME": "Э.Золбоо",
            "DELETED_DATE": null,
            "DELETED_USER_ID": null,
            "DELETED_USER_NAME": null,
            "COMPANY_DEPARTMENT_ID": null,
    ...
    {
      "structureIndicatorId": "16778287885139",
      "clear": {
        "tableName": "",
        "column": "ID",
        "dtl": []
    ...
    {
      "structureIndicatorId": "16759182808069",
      "clear": {
        "tableName": "",
        "column": "ID",
        "dtl": [
    ...
    {
      "structureIndicatorId": "16759182810429",
      "clear": {
        "tableName": "VT_DATA.V_16759182810429",
        "column": "ID",
        "dtl": [
          {
            "tableName": null,
    ...
    {
      "structureIndicatorId": "16776635016289",
      "clear": {
        "tableName": "VT_DATA.V_16776635016289",
        "column": "ID",
        "dtl": [
          {
            "tableName": "VT_DATA.V_17107597980599",
        ...
        "C2": [
          {
            ...
            "C7": "150000000",
            "C8": "АӨНХАХИ JSON-S",
            "SRC_RECORD_ID": "1722334108682441",
            "ID": "1722332012179163"
          }
        ]
      },
    ...
    {
      "structureIndicatorId": "16776635246899",
      "clear": {
        "tableName": "VT_DATA.V_16776635246899",
        "column": "ID",
        "dtl": []
      },
      "recordId": 1714209995456770,
    ...
    {
      "structureIndicatorId": "16778251936469",
      "clear": {
        "tableName": "",
        "column": "ID",
        "dtl": [
    ...
    {
      "structureIndicatorId": "16778287957539",
      "clear": {
        "tableName": "",
        "column": "ID",
        "dtl": []
    ...
    {
      "structureIndicatorId": "16778310860379",
      "clear": {
        "tableName": "",
        "column": "ID",
        "dtl": []
    ...
    {
      "structureIndicatorId": "16778287860319",
      "clear": {
        "tableName": "",
        "column": "ID",
        "dtl": []
    ...
    {
      "structureIndicatorId": "16778310855259",
      "clear": {
        "tableName": "",
        "column": "ID",
        "dtl": []
    ...
    {
      "structureIndicatorId": "16778310857769",
      "clear": {
        "tableName": "VT_DATA.V_16778310857769",
        "column": "ID",
        "dtl": []
      },
      "recordId": 1714209995456770,
    ...
    {
      "structureIndicatorId": "16775779291129",
      "clear": {
        "tableName": "VT_DATA.V_16775779291129",
        "column": "ID",
        "dtl": [
          {
            "tableName": "VT_DATA.V_17107597980599",
    ...
    {
      "structureIndicatorId": "16757666236419",
      "clear": {
        "tableName": "VT_DATA.V_16757666236419",
        "column": "ID",
        "dtl": [
          {
            "tableName": "VT_DATA.V_17107584217119",
            "column": "SRC_RECORD_ID"
          }
        ]
      },
    ...
    {
      "structureIndicatorId": "16776634285149",
      "clear": {
        "tableName": "VT_DATA.V_16776634285149",
        "column": "ID",
        "dtl": [
          {
            "tableName": "VT_DATA.V_17110768129449",
    ...
    public function jsonDataInsertDelete($reloationRow) {
        if ($reloationRow['recordId'] && $reloationRow['data']) {
            ...
            if ($reloationRow['clear']['tableName']) {
                $this->db->Execute('DELETE FROM '.$reloationRow['clear']['tableName'].' WHERE '.$reloationRow['clear']['column'].' = '.$deleteIdPh, [$reloationRow['recordId']]); 
            }
...
//                if (16776635016289 == $reloationRow['structureIndicatorId']) {
//                    pa($reloationRow['data']);
//                }
