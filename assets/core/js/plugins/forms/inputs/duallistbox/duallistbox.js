  ...
  BootstrapDualListbox.prototype = {
    ...
    setBootstrap2Compatible: function(value, refresh) {
      ...
      if (value) {
        ...
        this.container.find('input, select').addClass('form-control form-control-sm bootstrap-duallistbox');
        this.container.find('.btn').addClass('btn-sm btn-default');
        this.container.find('.moveall > i, .move > i').addClass('icon-arrow-right22 font-size-20');
        this.container.find('.removeall > i, .remove > i').addClass('icon-arrow-left22 font-size-20');
      }
      if (refresh) {
        refreshSelects(this);
      }
